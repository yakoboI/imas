...
const SEO = ({
  ...
  description = 'Manage inventory, products, orders, and warehouses. Track revenue, manage budgets, and optimize financial performance with real-time analytics and reporting for your business.',
  ...
  image = 'https://app.inventora.store/icon-512x512.png',
    ...
    <Helmet>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          name: 'Adventora',
          url: 'https://app.inventora.store',
          logo: 'https://app.inventora.store/icon-192x192.png',
