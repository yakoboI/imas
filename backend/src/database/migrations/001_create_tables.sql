...
CREATE INDEX idx_system_logs_archive_superadmin_id ON system_logs_archive(superadmin_id);
CREATE INDEX idx_system_logs_archive_target_tenant_id ON system_logs_archive(target_tenant_id);
CREATE INDEX idx_system_logs_archive_action ON system_logs_archive(action);
CREATE INDEX idx_system_logs_archive_timestamp ON system_logs_archive(timestamp);
CREATE INDEX idx_system_logs_archive_archived_at ON system_logs_archive(archived_at);
